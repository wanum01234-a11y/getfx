...
import { LayoutDashboard, Activity, History, Settings, Bell, Search, User, MessageCircle, Calculator, Sun, Moon } from "lucide-react";
...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div
      className={cn(
        "min-h-[100dvh] text-foreground flex flex-col md:flex-row relative overflow-hidden",
